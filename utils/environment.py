...
# para testar, carrega o ambiente virtual
...
def parse_comma_sep_str_to_list(comma_sep_str):
    # it avoids processing if comma_sep_str equal none
    if not comma_sep_str or not isinstance(comma_sep_str, str):
        return []
    # if string, it makes to return none
    # strip() removes the space in blank
